            ...
            <div class="container px-lg-5">
                <div class="row g-5">
                    <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
                        ...
                        <p class="mb-4">Zuppa Clean adalah sebuah start-up yang bergerak di bidang jasa layanan
                            kebersihan dimana pada era revolusi 4.0 ini banyak yang membutuhkan jenis jasa seperti ini.
                        </p>
                        <h3>Visi</h3>
                        <ul>
                            <li> Menjadi Perusahaan penyedia jasa Terkemuka se-Asia Tenggara dan #1 Pilihan Pelanggan
                                untuk Solusi efektivitas.</li>
                        </ul>
                        <h3>Misi</h3>
                        <ul>
                            <li>Menjalankan bisnis Jasa yang berorientasi pada kepuasan pelanggan, dan anggota
                                perusahaan</li>
