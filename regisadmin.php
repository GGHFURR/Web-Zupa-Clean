...
if (isset($_POST['submit'])) {
    ...
    if ($password == $cpassword) {
        ...
        if (!$result->num_rows > 0) {
            ...
            $sql = "INSERT INTO admin (username, email, password, gambar)
                    VALUES ('$username', '$email', '$password', '$asoy')";
                            ...
                            <div class="card text-center animated zoomIn">
                                <div class="card-body p-lg-5 ">
                                    <form action="" method="POST" class="login-email" enctype="multipart/form-data">
                                        <p class="login-text text-dark" style="font-size: 2rem; font-weight: 800;">
                                            Register Mitra</p>
                                        ...
                                        <button name="submit" class="btn btn-dark text-center my-3">Register</button>

                                        <p class="login-register-text">Anda sudah punya akun? <a href="index.php">Login
                                            </a></p>
                                    </form>
                                </div>
                            </div>
