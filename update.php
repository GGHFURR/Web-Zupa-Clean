                    ...
                    <div class="col-lg-7">
                        ...
                        <div class="wow fadeInUp" data-wow-delay="0.3s">
                            <form action="updatedata.php" method="post">
                                ...
                                ?>
                                    <input type="hidden" name="id" value="<?= $record['id_pesanan']  ?>">
                                    <div class="row g-3">
                                        <div class="col-md-6">
                                            <div class="form-floating">
                                                <input type="text" class="form-control" name="nama" placeholder="Nama" value="<?= $record['nama_customer'] ?>" required>
                                                <label for="name">Masukkan Nama Anda</label>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-floating">
                                                <input type="text" class="form-control" name="no_hp" value="<?= $record['no_hp'] ?>" placeholder="Email" required>
                                                <label for="email">Masukkan Nomor Telpon</label>
                                            </div>
                                        </div>
                                        <div class="col-12">
                                        ...
                                        <div class=" col-12">
                                            <div class="form-floating">
                                                <input type="number" class="form-control" name="jam" placeholder="subjek" value="<?= $record['lama_sewa'] ?>" required>
                                                <label for="subject">Lama Sewa(dalam jam)</label>
                                            </div>
                                        </div>
                                        <div class=" col-12">
                                            <div class="form-floating">
                                                <input type="text" class="form-control" name="alamat" value="<?= $record['alamat'] ?>" placeholder="subjek" required>
                                                <label for="subject">Alamat Tujuan(isi dengan lengkap)</label>
                                            </div>
                                        </div>
                                        <div class="col-12">
                                            <div class="form-floating">
                                                <textarea class="form-control" placeholder="Pesan" name="pesan" style="height: 150px" value="<?= $record['catatan'] ?>"></textarea>
                                                <label for="message">Masukkan Pesan Anda</label>
                                            </div>
                                        </div>
                                        <div class="col-12">
                                            <button class="btn btn-primary w-100 py-3" name="update" id="update" type="submit">Change Order</button>
                                        </div>
                                    </div>
                                <?php
                                endforeach;
